...
class ventaRoutes {
    ...
    config() {
        ...
        this.router.delete('/eliminarVenta/:id', auth_1.validarToken, ventaController_1.ventaController.eliminar_venta);
        this.router.put('/modificarVenta/:id', auth_1.validarToken, ventaController_1.ventaController.modificar_venta);
        this.router.get('/mostrarTodasVenta/', auth_1.validarToken, ventaController_1.ventaController.mostrar_Todas_venta);
