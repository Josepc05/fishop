...
class productoRoutes {
    ...
    config() {
        ...
        this.router.get('/mostrarporCategoriaProducto/:nombre_categoria', productoController_1.productoController.mostrar_porCategoria_producto);
        ...
        this.router.get('/mostrarporCantidadProducto/:cantidad', productoController_1.productoController.mostrar_porCantidad_producto);
        //nueva consulta
        this.router.get('/obtenerNombreProducto/:id', productoController_1.productoController.obtenerNombrePorId);
        this.router.get('/buscarProducto/:nombre_categoria', productoController_1.productoController.buscarProductoPorNombreoCategoria);
    }
}
